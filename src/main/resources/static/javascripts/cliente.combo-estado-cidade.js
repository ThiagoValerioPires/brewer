...
Brewer.ComboCidade = (function() {
    ...
    ComboCidade.prototype.iniciar = function() {
        ...
        let codigoEstado = this.comboEstado.combo.val();
    ...
    function onBuscarCidadesFinalizado(cidades) {
        ...
        let codigoCidadeSelecionada = this.inputHiddenCidadeSelecionada.val();
...
$(function() {
    ...
    let comboEstado = new Brewer.ComboEstado();
    comboEstado.iniciar();

    let comboCidade = new Brewer.ComboCidade(comboEstado);
    comboCidade.iniciar();
